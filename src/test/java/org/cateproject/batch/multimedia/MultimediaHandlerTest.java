...
public class MultimediaHandlerTest {
    ...
    public void setUp() {
        ...
        multimediaHandler.setProcessMultimediaJob(job);
    ...
    public void testProcess() {
        ...
        EasyMock.replay(fileTransferService, multimediaFileService, jobLaunchRequestHandler, conversionService);
        multimediaHandler.process(multimedia);
        EasyMock.verify(fileTransferService, multimediaFileService, jobLaunchRequestHandler, conversionService);
    }
