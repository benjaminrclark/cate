...
public class MultitenantManagerTest {
	...
	public void testCreateAdminAccountsDefault() {		
		...
		assertTrue("Admin should be able to administrate", capturedAdmin.getValue().getPermissions().contains(Permission.ROLE_ADMINISTRATE));
		assertTrue("Admin should be able to configure tenants", capturedAdmin.getValue().getPermissions().contains(Permission.ROLE_CONFIGURE_SYSTEM));
		assertTrue("Admin should be able to edit", capturedAdmin.getValue().getPermissions().contains(Permission.ROLE_EDIT));
		...
		assertTrue("Owner should be able to administrate", capturedOwner.getValue().getPermissions().contains(Permission.ROLE_ADMINISTRATE));
		assertFalse("Owner should not be able to configure tenants", capturedOwner.getValue().getPermissions().contains(Permission.ROLE_CONFIGURE_SYSTEM));
		assertTrue("Owner should be able to edit", capturedOwner.getValue().getPermissions().contains(Permission.ROLE_EDIT));
	}
